	...
	<ItemTemplate>
		<div class="row">
			<div class="col-xs-3 col-sm-2 col-md-1 text-center">
				<div>
					<span class="icon file <%#((UploadedFile)Container.DataItem).DisplayFileExtension%>"></span>
				</div>
			...
			<div class="col-xs-9 col-sm-10">
				...
				<div>
					...
					<span class="label label-default" id="LastDownload"></span>&nbsp;
					<script type="text/javascript">filesDetail.updateDateTime('<%#(((UploadedFile)Container.DataItem).LastDownload==null?"":((UploadedFile)Container.DataItem).LastDownload.Value.ToString("R")) %>', '#LastDownload');</script>
				</div>
				<div>
